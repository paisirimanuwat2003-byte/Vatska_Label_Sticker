...
class welcome_page(Frame):
    def __init__(self,parent, controller):
        ...
        agilent_label.pack(padx=5, pady=10)
        ...
        welco_label.pack(padx=5, pady=10)
        ...
        electrolux_label.pack(padx=5, pady=10)
        ...
        taat_label.pack(padx=5, pady=10)
        ...
        # Force it exactly to the top-left corner
        decor_label.place(x=0, y=0, anchor=tk.NW)   
