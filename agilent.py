...
class agilent(Frame):
    def __init__(self, parent, controller):
        ...
        btn_copy3 = tk.Button(self, text="ถุงเล็ก (x.3)", command=copy_3, state="disabled")
        btn_copy3.pack(pady=5, padx=50)

        btn_copy4 = tk.Button(self  , text="ถุงเล็ก (x.4)", command=copy_4, state="disabled")
        btn_copy4.pack(pady=5, padx=50)

        btn_copy5 = tk.Button(self, text="ถุงเล็ก (x.5)", command=copy_5, state="disabled")
        btn_copy5.pack(pady=5, padx=50)

        btn_copy6 = tk.Button(self, text="ถุงใหญ่", command=copy_6, state="disabled")
        btn_copy6.pack(pady=5, padx=50)

        btn_copy7 = tk.Button(self, text="กล่อง", command=copy_7, state="disabled")
        btn_copy7.pack(pady=5, padx=50)

        btn_copy8 = tk.Button(self, text="Barcode", command=copy_8, state="disabled")
        btn_copy8.pack(pady=5, padx=50)

        btn_home = tk.Button(self, text="กลับหน้าแรก", command=lambda: self.controller.show_frame("welcome_page"))
